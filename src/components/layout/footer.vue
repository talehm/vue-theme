			...
			<v-container>
				<v-row align="start">
					<v-col cols="12" md="3">
						...
						<p class="text-body-1"> Read, Listen, Learn every day! </p>
					</v-col>
					<v-col cols="12" md="3">
						<v-list color="transparent" flat>
							<!-- <v-subheader class="text-h6">HeroUI</v-subheader> -->
							<!-- <v-list-item-group color="primary">
								<v-list-item v-for="(item, i) in heroui" :key="i" :href="item.href" dense
									target="_black">
									<v-list-item-content>
					...
					<v-col cols="12" md="3">
						<v-list color="transparent" flat>
							...
							<v-list-item-group color="primary">
								<v-list-item v-for="(item, i) in shock" :key="i" :href="item.href" dense
									target="_black">
									<v-list-item-content>
										<v-list-item-title class="text-body-1" v-text="item.text"></v-list-item-title>
									</v-list-item-content>
					...
					<v-col cols="12" md="3">
						<div>
							...
							<p class="text-body-1"> The latest Rocket news, articles, and resources, sent straight to
				...
				<div class="text-center mt-6"> Copyright &copy; <a class="white--text" href="https://heroui.net"
						rel="noopener noreferrer" target="_blank">trueandfiction.com</a>
